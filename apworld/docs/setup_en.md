...
- The latest version of the RWBY Grimm Eclipse Archipelago mod (currently only distributed in the Archipelago Discord server due to the highly WIP state)
...
2. Install the **32-bit** version of the BepInEx mod loader as described in their [installation guide](https://docs.bepinex.dev/articles/user_guide/installation/index.html) (Linux users: install the windows version of BepInEx)
    * **[Linux only]** Set the launch command in Steam to `WINEDLLOVERRIDES="winhttp=n"`
3. Run the game to have BepInEx generate a config file and close it after it reached the main menu
